...
<form method= "post" action = "SecondAddAuthor.php">
  ...
  <label>
    <input type="text" placeholder="Author ID" name = "AuthorID" />
  </label>
  ...
  <button class="red" type="submit"><i class="icon ion-md-lock"></i> Add Author</button>
